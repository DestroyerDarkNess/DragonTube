Imports MusiCloud.Types
Imports System.ComponentModel
Imports System.Security.Permissions
Imports MusiCloud.Win32FX
...
<DisplayName("MyControl")>
    ...
    Private Sub Panel2_MouseWheel(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseWheel
        If Me.Bounds.Contains(e.Location) Then
            Dim vScrollPosition As Integer = Me.VerticalScroll.Value
            vScrollPosition = e.Location.Y
            Me.Invalidate()
        End If
    End Sub

    Private Sub Panel2_MouseEnter(sender As Object, e As EventArgs) Handles Me.MouseEnter
        Me.Select()
    End Sub
